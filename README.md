# TCC 2 — Comparação de Ferramentas API-First sobre PostgreSQL
...
- [Grafana k6](https://grafana.com/docs/k6/latest/set-up/install-k6/) (necessário apenas para os testes de desempenho)
