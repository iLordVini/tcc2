...
def main():
    ...
    scripts = [
        ("DreamFactory", find_script(base, ["dreamfactory/dreamfactory_performance_80_20.py"])),
        ("NocoDB", find_script(base, ["nocodb/nocodb_performance_80_20.py"])),
        ("pREST", find_script(base, ["prest/prest_performance_80_20.py"])),
        ("PostgREST", find_script(base, ["postgrest/postgrest_performance_80_20.py"]))
    ]
