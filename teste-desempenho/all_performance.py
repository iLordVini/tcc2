...
def main():
    ...
    scripts = [
        ("DreamFactory", find_script(base, ["dreamfactory/dreamfactory_performance.py"])),
        ("DreamFactory_80_20", find_script(base, ["dreamfactory/dreamfactory_performance_80_20.py"])),
        ("DreamFactory_60_40", find_script(base, ["dreamfactory/dreamfactory_performance_60_40.py"])),
        ("NocoDB", find_script(base, ["nocodb/nocodb_performance.py"])),
        ("NocoDB_80_20", find_script(base, ["nocodb/nocodb_performance_80_20.py"])),
        ("NocoDB_60_40", find_script(base, ["nocodb/nocodb_performance_60_40.py"])),
        ("pREST", find_script(base, ["prest/prest_performance.py"])),
        ("pREST_80_20", find_script(base, ["prest/prest_performance_80_20.py"])),
        ("pREST_60_40", find_script(base, ["prest/prest_performance_60_40.py"])),
        ("PostgREST", find_script(base, ["postgrest/postgrest_performance.py"])),
        ("PostgREST_80_20", find_script(base, ["postgrest/postgrest_performance_80_20.py"])),
        ("PostgREST_60_40", find_script(base, ["postgrest/postgrest_performance_60_40.py"]))
    ]
