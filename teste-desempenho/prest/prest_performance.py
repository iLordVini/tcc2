...
BASE_URL = "http://localhost:3001/marketplace/public"
HINT = "prest"
...
def main():
    ...
    resultados = {"ferramenta": "pREST", "cenario": "100% GET", "timestamp": start_ts, "testes": {}}
    workdir = script_dir
    for profile_name in ["load", "stress", "spike", "soak"]:
        resultados["testes"][profile_name] = run_k6(profile_name, workdir, run_dir)
        time.sleep(3)
    (script_dir / f"results_prest_get_100_{start_ts}.json").write_text(
