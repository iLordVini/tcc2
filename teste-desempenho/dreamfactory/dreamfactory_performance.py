...
BASE_URL = "http://localhost:3002/api/v2/public/_table"
API_KEY = "46624cdc2e657389f229066bf9092e8accea917c0c426fe2b8e0ac2edf80b0ac"
HINT = "dreamfactory"
...
def main():
    ...
    resultados = {"ferramenta": "DreamFactory", "cenario": "100% GET", "timestamp": start_ts, "testes": {}}
    workdir = script_dir
    for profile_name in ["load", "stress", "spike", "soak"]:
        resultados["testes"][profile_name] = run_k6(profile_name, workdir, run_dir)
        time.sleep(3)
    (script_dir / f"results_dreamfactory_get_100_{start_ts}.json").write_text(
